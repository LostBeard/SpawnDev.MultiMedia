...
namespace PlaywrightMultiTest
{
    public class ProjectRunner
    {
            ...
            foreach (var project in projects)
            {
                if (project.AppProjectType == ProjectType.BlazorWasm)
                {
                    ...
                    try
                    {
                        ...
                        var userDataDir = Path.Combine(Path.GetTempPath(), "SpawnDev.MultiMedia.PlaywrightProfile");
                        ...
                        testableProject.BrowserContext = await testableProject.Playwright.Chromium.LaunchPersistentContextAsync(
                            ...
                            new BrowserTypeLaunchPersistentContextOptions
                            {
                                ...
                                Args = new[]
                                {
                                    ...
                                    // Fake media devices for testing (no real camera/mic needed)
        ...
        public IEnumerable<TestCaseData> GetPlaywrightTasks()
        {
            ...
            // Future: cross-platform media tests (camera preview, audio capture)
        }

        /// <summary>
        /// This is called after tests have been enumerated but before they are run. You can use this to start up any services or infrastructure needed for the tests.
        /// </summary>
        /// <returns></returns>
